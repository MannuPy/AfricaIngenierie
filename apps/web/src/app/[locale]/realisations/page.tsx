...
import type { RealisationDoc } from '../../../lib/types'
import { notFound } from 'next/navigation'

export const revalidate = 300

const PAGE_KEY = 'realisations'
const SECTION = 'realisations' as const
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const docs = await findPublished<RealisationDoc>('realisations', locale, { sort: '-year' })
