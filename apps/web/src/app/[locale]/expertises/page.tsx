...
import type { ExpertiseDoc } from '../../../lib/types'
import { notFound } from 'next/navigation'

export const revalidate = 300

const PAGE_KEY = 'expertises'
const SECTION = 'expertises' as const
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const docs = await findPublished<ExpertiseDoc>('expertises', locale, { sort: 'position' })
